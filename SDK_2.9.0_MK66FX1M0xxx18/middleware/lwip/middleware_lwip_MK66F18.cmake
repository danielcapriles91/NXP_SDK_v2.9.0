if(NOT MIDDLEWARE_LWIP_MK66F18_INCLUDED)
    
    set(MIDDLEWARE_LWIP_MK66F18_INCLUDED true CACHE BOOL "middleware_lwip component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_lwip_empty_ethernetif_MK66F18)
         include(middleware_lwip_empty_ethernetif_MK66F18)
    endif()
    if(CONFIG_USE_middleware_lwip_usb_ethernetif_MK66F18)
         include(middleware_lwip_usb_ethernetif_MK66F18)
    endif()
    if(CONFIG_USE_middleware_lwip_enet_ethernetif_MK66F18)
         include(middleware_lwip_enet_ethernetif_MK66F18)
    endif()
    if(NOT (CONFIG_USE_middleware_lwip_empty_ethernetif_MK66F18 OR CONFIG_USE_middleware_lwip_usb_ethernetif_MK66F18 OR CONFIG_USE_middleware_lwip_enet_ethernetif_MK66F18))
        message(WARNING "Since middleware_lwip_empty_ethernetif_MK66F18/middleware_lwip_usb_ethernetif_MK66F18/middleware_lwip_enet_ethernetif_MK66F18 is not included at first or config in config.cmake file, use middleware_lwip_empty_ethernetif_MK66F18 by default.")
        include(middleware_lwip_empty_ethernetif_MK66F18)
    endif()
